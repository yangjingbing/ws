...
//        String listSql = "SELECT carnum,COUNT(1) n,description,dt,sip FROM t_car t WHERE LEFT(t.description,2)<>'卡号' and dt>=? GROUP  BY t.description ";
        String listSql = "SELECT carnum,COUNT(1) n,description,dt,sip,pasted FROM t_car t WHERE dt>=? GROUP  BY t.description,t.carnum ";
    ...
    public static void main(String[] args) {
        ...
        Matcher matcher = r.matcher("卡号：8059绑定的车辆符合放行条件  进入");
        ...
        System.out.println("=========");
        Matcher matcher2 = r.matcher("卡号：8059,8100,8191,8193绑定的车辆符合放行条件  进入");
        while (matcher2.find()) {
