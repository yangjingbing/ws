...
//        String C_ip = Objects.isNull(redisUtil.getCnStr("C-" + cardList.get(0).getCip())) ? "" : redisUtil.getCnStr("C-" + cardList.get(0).getCip()).toString().substring(1,9);
//        output.setCarnum(C_ip);
