...
import com.cp.zf.util.CompareDate;
import lombok.val;
...
//                          StationStatusServer.StationStatusServer(jdbcTemplate, lastt);
                    ...
                    /*CompletableFuture.runAsync(() -> {
                        try {
                            RykJbxxServer.RykInfo(jdbcTemplate,lastt);
                            System.out.println("PersonService cost=" + (System.currentTimeMillis() - lastt));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    /*CompletableFuture.runAsync(() -> {
                        try {
                            BarrierServer.BarrierInfo(jdbcTemplate,lastt);
                            System.out.println("PersonService cost=" + (System.currentTimeMillis() - lastt));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    /*CompletableFuture.runAsync(() -> {
                        try {
                            RyJbxxServer.RyInfo(jdbcTemplate,lastt);
                            System.out.println("PersonService cost=" + (System.currentTimeMillis() - lastt));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    /*CompletableFuture.runAsync(() -> {
                        try {
                            StationServer.StationInfo(jdbcTemplate,lastt);
                            System.out.println("PersonService cost=" + (System.currentTimeMillis() - lastt));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                   ...
                   /* CompletableFuture.runAsync(() -> {
                        try {
                            RyQyServer.RyQyInfo(jdbcTemplate,lastt);
                            System.out.println("PersonService cost=" + (System.currentTimeMillis() - lastt));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
