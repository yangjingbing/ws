...
public class ConvertUtil {
    private static double[] xy1 = {-1294.07, 1594.18};
    private static double[] xy2 = {-1873.34, 1831.17};
    private static double[] lonlat1 = {120.0527787, 34.2993269};
    private static double[] latlon = {120.0464487, 34.3014009};
    private static double angle = 0;
//120.052718------34.299128
    ...
    public static double[] xy2lonlat(double x, double y) {
      ...
      public static void main(String[] args) {
        ...
        double[] lanxy = xy2lonlat(20.30,-10.66);
        double x = lanxy[0];
        double y = lanxy[1];
