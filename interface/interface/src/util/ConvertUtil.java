...
public class ConvertUtil
{
    ...
    private static double[] xy1 = { 713.79108, 1056.76925 };
    private static double[] xy2 = { 950.05798,32.18725 };
    private static double[] lonlat1 = { 119.001731,33.378338 };
    private static double[] latlon = { 119.003320,33.373820 };
    ...
    public static void main(String[] args){
        double[] lanxy = xy2lonlat(154.3039999999985,390.0479999999997);
        double x = lanxy[0];
        double y = lanxy[1];
